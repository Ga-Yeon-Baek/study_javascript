...
/**
 * `(백틱 이라고 부르는 듯)이 기호로 감싼 출력값은 그대로 출력이 된다.
 */
 ...
 * 변수를 선언할 지 명시를 한다.
 * 
 * dynamic typing -> 변수의 타입을 명시적으로
 * 선언하지 않고 값에 의해 타입을 "추론" 한다.
 * JS -> dynamic typing
 */